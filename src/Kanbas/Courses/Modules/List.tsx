    ...
    <>
      ...
      <div>
        <div className="float-right">
          ...
          <button type="button" className="btn modules-module-button-style" onClick={handleAddModule}>
            + Module
          </button>
        ...
        <button type="button" className="btn modules-buttons-styles margin-right-10" onClick={handleAddModule}>
          Add
        </button>

        <button type="button" className="btn modules-buttons-styles" onClick={handleUpdateModule}>
          Update
        </button>
            ...
            <li key={index}
              ...
              <div className="list-group-header-style">
                ...
                <span className="float-end">
                  ...
                  <button className="transparent-background-button"
                    onClick={() => handleDeleteModule(module._id)}><FaTrash className="ms-2" /></button>
